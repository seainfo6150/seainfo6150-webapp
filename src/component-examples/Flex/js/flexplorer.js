    $(function() {
        ...
        $(window).load(function() {
            ...
            $('#container-height-control, #container-width-control, #flex-direction-control, #flex-wrap-control').change(function() {
                var flex_direction_val = $('#flex-direction-control :selected').val();
                var flex_wrap_val = $('#flex-wrap-control :selected').val();
                var container_height_val = $('#container-height-control').val();
                const container_height = container_height_val === "auto" ? "" : '\theight: ' + container_height_val + ';\n';
                var container_width_val = $('#container-width-control').val();
                const container_width = container_width_val === "auto" ? "" : '\twidth: ' + container_width_val + ';\n';
